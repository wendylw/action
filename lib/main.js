...
async function runChromatic(options) {
  ...
  console.log(typeof options.packageJsonPath);
  console.log(options.packageJsonPath);
  const packagePath = await pkg_up_1.default(options.packageJsonPath); // the user's own package.json
  console.log(await pkg_up_1.default(options.packageJsonPath));
...
async function run() {
  ...
  try {
    ...
    const packageJsonPath = core_1.getInput('packageJsonPath');
